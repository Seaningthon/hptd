...
try: 
    opts, args = getopt.getopt(sys.argv[1:], "c:lr:ws:wd:agb:", ["checkpoint_dir=", "lr=","ws=","wd=", "agb="]) 
...
epochs = 1  # do not change this
logger = True  # use your experiment tracking tool's logger
